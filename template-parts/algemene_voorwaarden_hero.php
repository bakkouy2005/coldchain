<?php 
$algemene_voorwaarden_hero = get_field('algemene_voorwaarden_hero');

if( $algemene_voorwaarden_hero ) :
    $img       = $algemene_voorwaarden_hero['img'];         
    $text      = $algemene_voorwaarden_hero['text'];       
    $text_area = $algemene_voorwaarden_hero['text_area']; 
?>
